...
def get_transform_score(model, dataset, transform, 
                        num_iterations=5, num_workers=0, batch_size=64):
...
def get_adv_score(model, dataset, constraint='inf', eps=0.04, iterations=20, 
                  transform=None, batch_size=128, num_workers=0, num_iterations=1):
    attack_kwargs = {
